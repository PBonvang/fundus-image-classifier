...
import config
from utils.dataloading import get_sample_dataloader
...
if __name__ == '__main__':
  ...
  dataset = get_sample_dataloader('IsFundusImage\Data\samlet', batch_size=Model.batch_size, transforms=Model.training_transforms)
